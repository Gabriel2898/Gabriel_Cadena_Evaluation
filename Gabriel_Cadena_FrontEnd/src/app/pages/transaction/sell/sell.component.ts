...
export class SellComponent implements OnInit {
  ...
  id?:number = 0;
  constructor(private productService: ProductService ,private dialogo:MatDialogRef<SellComponent>,private fb:FormBuilder, private snackBar: MatSnackBar, private transactionService:TransactionService) {
